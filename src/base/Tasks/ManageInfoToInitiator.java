...
public class ManageInfoToInitiator implements Runnable {
    ...
    public ManageInfoToInitiator(int sender_id, String file_id, int num, InetSocketAddress address, SSLSocket client_socket) {
        this.info_message = new InfoMessage(REPLYINFOINITIATOR, sender_id, file_id, num, address);
